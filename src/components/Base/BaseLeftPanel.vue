<template>
  <v-card class="mx-auto pa-2" min-width="300" height="100%" :class="'PanelLeft'">
    <v-list>
      <v-list-subheader :class="'PanelLeft__title'">Навигация</v-list-subheader>

      <v-list-item v-for="(item, i) in items" :key="i" :value="item" color="primary" rounded="l"
...
import { ref } from "vue";
const items = ref([
  { text: 'НА СКАЛАДЕ', icon: 'mdi-tools ' },
